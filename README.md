...
Added a functionality for counting the amount of x times the user got the correct answer
when a user selects the wrong bigger number it turns streak to 0

may add in future a time counter (to track how many bigger numbers you got correct in x amount of time)
